...
@section('content')
    ...
    <script>
        window.onload = function() {
            notif({
                msg: "تم تغيير حالة الفاتورة بنجاح",
                type: "success"
            })
        }
    </script>
@endif
    ...
    @if (session()->has('success'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <button style="left: 0" type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><a
                                                                    href="{{ route('sections.show', $invoice->Section) }}">{{ $invoice->Section->section_name }}</a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a
                                                                    href="{{ route('products.show', $invoice->product) }}">{{ $invoice->product->product_name }}</a>
                                                            </td>
                                                    ...
                                                    <form method="post" action="{{ route('add-attachment') }}"
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" id="customFile"
                                                                name="pic" required>
                                                            <input type="hidden" id="customFile" name="user_id"
                                                                value="{{ auth()->id() }}">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($invoice->attachments as $attachment)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $attachment->created_at->diffForHumans() }}
                                                                    </td>
                                                                    <td colspan="2">
                                                                        <a class="btn btn-outline-success btn-sm" target="_blank"
                                                                            href="{{route('show-attachment',$attachment->id)}}"
                                                                            role="button"><i
                                                                                class="fas fa-eye"></i>&nbsp;
                                                                            عرض</a>

                                                                        <a class="btn btn-outline-info btn-sm"
                                                                            href="{{route('download-attachment',$attachment->id)}}"
                                                                            role="button"><i
                                                                        ...
                                                                        <button class="btn btn-outline-danger btn-sm"
                                                                            data-toggle="modal"
                                                                            data-id_file="{{ $attachment->id }}" data-invoice_number='{{$invoice->invoice_number}}'
