        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('/' . $page='index') }}"><img
                        src="{{ URL::asset('assets/img/brand/logo.png') }}" class="logo-1"
                        alt="logo"></a>
                <a href="{{ url('/' . $page='index') }}"><img
                            ...
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                            href="{{route('mark_as_read')}}">تعين قراءة الكل</a></span>
                                </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <form class="dropdown-item" method="POST" action="{{ route('logout') }}"><i
                                class="bx bx-log-out">
                                @csrf
                            </i> <input value="Sign Out" type="submit" class="bg-white border-0"></form>
                    </div>
                </div>
