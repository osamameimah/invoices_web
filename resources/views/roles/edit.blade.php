...
<link href="{{ URL::asset('assets/plugins/fontawesome-free/css/all.min.css') }}"
    rel="stylesheet">
<!--Internal  treeview -->
                                    ...
                                    <ul>
                                        <li>
                                            @foreach($permissions as $value)
                                                <label>
                                                    {{ $value->name }}
                                                    <input type="checkbox" name="permission[]" {{in_array($value->id, $rolePermissions) ? 'checked' : ''}}   class="name" value="{{$value->id}}">
                                                </label>
                                                <br />
                                            @endforeach
                                        </li>
